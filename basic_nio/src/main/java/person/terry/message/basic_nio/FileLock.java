...
public class FileLock {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileLock lockTest = new FileLock();
        if (writer) {
    ...
    void doQueries(FileChannel fc) throws Exception {
        ...
        while (true) {
            ...
            java.nio.channels.FileLock lock = fc.lock(INDEX_START, INDEX_SIZE, true);
    ...
    void doUpdates(FileChannel fc) throws Exception {
        while (true) {
            ...
            java.nio.channels.FileLock lock = fc.lock(INDEX_START, INDEX_SIZE, false);
            updateIndex(fc);
            lock.release();
            println("<sleeping>");
